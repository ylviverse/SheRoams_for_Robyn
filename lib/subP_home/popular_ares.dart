...
import 'package:she_roams_bali/popular_areas/seminyak.dart';
import 'package:she_roams_bali/popular_areas/ubud.dart';
...
class _PopularAresState extends State<PopularAres> {
  ...
  Widget build(BuildContext context) {
    final currentAreas = selectedTab == 'Recommended'
        ? recommendedAreas
        : nearbyAreas;
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Row(
                children: [
                  Expanded(child: _buildTabButton('Recommended')),
                  const SizedBox(width: 12),
                  Expanded(child: _buildTabButton('Nearby')),
                ],
              ),
            ),
          ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected
              ? const Color(0xFFffcad4).withValues(alpha: 0.6)
              : Colors.white,
    ...
    return GestureDetector(
      onTap: () {
        if (title == 'Ubud') {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const UbudDetail()),
          );
        } else if (title == 'Seminyak') {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const SeminyakDetail()),
          );
        } else {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('$title detail page coming soon!'),
